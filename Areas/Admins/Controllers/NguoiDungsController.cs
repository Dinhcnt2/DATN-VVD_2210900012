...
namespace VVD_2210900012_DATN.Areas.Admins.Controllers
{
    ...
    public class NguoiDungsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaNguoiDung,TenDangNhap,MatKhau,HoTen,Email,Sdt,VaiTro,NgayTao")] NguoiDung nguoiDung)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaNguoiDung,TenDangNhap,MatKhau,HoTen,Email,Sdt,VaiTro,NgayTao")] NguoiDung nguoiDung)
        {
